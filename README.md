...
The [examples](https://github.com/grpc/grpc-java/tree/v1.83.0/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.83.0/examples/android)
...
```gradle
runtimeOnly 'io.grpc:grpc-netty-shaded:1.83.0'
...
```gradle
implementation 'io.grpc:grpc-okhttp:1.83.0'
implementation 'io.grpc:grpc-protobuf-lite:1.83.0'
implementation 'io.grpc:grpc-stub:1.83.0'
```
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.83.0
...
<build>
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        <protocArtifact>com.google.protobuf:protoc:3.35.1:exe:${os.detected.classifier}</protocArtifact>
        <pluginId>grpc-java</pluginId>
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.83.0:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
...
protobuf {
  protoc {
    artifact = "com.google.protobuf:protoc:3.35.1"
  }
  plugins {
    grpc {
