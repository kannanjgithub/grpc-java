...
/**
 * Holds metric instrument definitions for client-side external processing.
 */
public final class ExternalProcessorClientInterceptorMetricInstruments {
  @VisibleForTesting
  ...
  private ExternalProcessorClientInterceptorMetricInstruments() {}
}
