...
/**
 * Holds metric instrument definitions for external processing.
 */
public final class ExternalProcessorMetricInstruments {
  @VisibleForTesting
  ...
  private ExternalProcessorMetricInstruments() {}
}
